...
<i class="fas fa-info-circle cursor-pointer" style="color: #fff; font-size: 16px; margin-left: 4px; cursor: pointer; display: inline-flex; align-items: center;" aria-hidden="true" data-toggle="popover" data-html="true" title="@lang('superadmin::lang.active_package_description')" data-placement="right" data-trigger="hover" data-content="
