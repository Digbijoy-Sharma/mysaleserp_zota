...
class SetSessionData
{
    ...
    public function handle($request, Closure $next)
    {
        if (! $request->session()->has('user')) {
            ...
            // Dava India: super admins have no business_id (FK was dropped
            // so the super admin can exist without a tenant). Skip
            // business / currency / financial-year session setup for them.
