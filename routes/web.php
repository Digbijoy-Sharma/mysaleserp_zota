...
Route::middleware(['setData', 'auth', 'RedirectSuperAdminFromBusinessRoutes', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
...
Route::middleware(['setData', 'auth', 'RedirectSuperAdminFromBusinessRoutes', 'SetSessionData', 'language', 'timezone'])->group(function () {
